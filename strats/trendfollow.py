...
class TrendFollow(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['wma_fast'] = ta.WMA(dataframe, timeperiod=10)
        dataframe['wma_slow'] = ta.WMA(dataframe, timeperiod=60)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (dataframe["wma_fast"] > (dataframe["wma_slow"])) &  # Uptrend
        ...
        dataframe.loc[
            (
                ...
                (dataframe["wma_fast"] < (dataframe["wma_slow"])) &  # Downtrend
                (dataframe['volume'] > 0)  # Make sure Volume is not 0
            ),
            'enter_short'] = 1
